...
membership_04 = Membership.create(user: user_03, research_group: research_group_02)
...
bird_capture_01 = BirdCapture.create(membership: membership_01, bird: bird_01, capture: capture_01)
bird_capture_02 = BirdCapture.create(membership: membership_03, bird: bird_01, capture: capture_02)
bird_capture_03 = BirdCapture.create(membership: membership_01, bird: bird_01, capture: capture_03)

bird_capture_04 = BirdCapture.create(membership: membership_01, bird: bird_02, capture: capture_04)
bird_capture_05 = BirdCapture.create(membership: membership_01, bird: bird_02, capture: capture_05)
bird_capture_06 = BirdCapture.create(membership: membership_03, bird: bird_02, capture: capture_06)

bird_capture_07 = BirdCapture.create(membership: membership_03, bird: bird_03, capture: capture_07)
bird_capture_08 = BirdCapture.create(membership: membership_01, bird: bird_03, capture: capture_08)
bird_capture_09 = BirdCapture.create(membership: membership_01, bird: bird_03, capture: capture_09)

bird_capture_10 = BirdCapture.create(membership: membership_02, bird: bird_04, capture: capture_10)
bird_capture_11 = BirdCapture.create(membership: membership_02, bird: bird_04, capture: capture_11)
bird_capture_12 = BirdCapture.create(membership: membership_04, bird: bird_04, capture: capture_12)

bird_capture_13 = BirdCapture.create(membership: membership_04, bird: bird_05, capture: capture_13)
bird_capture_14 = BirdCapture.create(membership: membership_02, bird: bird_05, capture: capture_14)
bird_capture_15 = BirdCapture.create(membership: membership_02, bird: bird_05, capture: capture_15)